  ...
  return (
      ...
      <div className={styles.ParentLog}>
          <ul className={styles.login_signup_tabs}>
              <li className={styles.tab_sig}><Link to={'/login'}>Login</Link></li>
              <li className={styles.tab_log}><Link to={'/signup'}>Sign Up</Link></li>
          </ul>
      ...
      <Button className={styles.spBt} onClick={logIn} >Login with Password</Button> 
      <p className={styles.Ors}>OR</p>
      <Button className={styles.otpsubmit} ><Link to={'/otp'}>Login With OTP</Link></Button>
